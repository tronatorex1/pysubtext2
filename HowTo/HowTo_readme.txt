...
1*Simple (este código permite en las dos partes, transcribir (de archivos de video o música, inclusive)):
...
2*Complejo (solución con TKinter para arrastrar el video a generar subtítulos):
